...
public class Main {
    public static void main(String[] args) throws IOException, ParseException {
        ...
        /*
        Read in the fasta entries to build an MSA from. Remember to change the input from a static path to a command line argument!
         */
        ArrayList<Fasta> sequences = FastaReader.readFasta(new File("./resources/to_msa.fasta"));
        // Catch scenarios in which not four entries were parsed.
        NeedlemanWunsch nw1 = new NeedlemanWunsch(3, -2, 4, sequences.get(0).getSequence(), sequences.get(1).getSequence());
        nw1.alignSequences();
        ArrayList<String> alignedSequences12 = nw1.getAlignedSequences();
        // ... Compute alignments for all sequence combinations.
        CombineProfiles.combineAlignedSequences(alignedSequences12, ... );
    }
}